  ...
  return (
    <View style={styles.switchContainer}>
      <Switch
        ...
        innerCircleStyle={{ alignItems: "center", justifyContent: "center", color: "red" }} // style for inner animated circle for what you (may) be rendering inside the circle
        outerCircleStyle={{ color: 'red' }} // style for outer animated circle
